...
from .stghwparam import STG_WAVE_SAMPLE_SIZE, STG_WORD_SIZE, NUM_SAMPLES_IN_STG_WORD, MIN_UNIT_SAMPLES_FOR_WAVE_PART
...
class Stimulus(object):
    ...
    def __init__(
        ...
        *,
        ...
        if enable_lib_log:
            self.__loggers.append(cmn.get_file_logger())
        ...
        try:
            ...
            cmn.log_error(e, *self.__loggers)
            raise
        ...
        def __getitem__(self, key):
            if isinstance(key, int):
                ...
                if (key < 0) or (self.__len <= key):
                    ...
                    cmn.log_error(msg, *self.__loggers)
