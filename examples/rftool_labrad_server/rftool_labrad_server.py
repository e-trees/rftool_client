...
class RftoolClientWrappedServer(LabradServer):
    ...
    def initServer(self):
        ...
        self.client = rftc.RftoolClient(logger)
        self.client.connect(ZCU111_IP_ADDR)
        self.wr_size = 0
        self.wr_pos = 0
        self.rd_size = 0
        self.rd_pos = 0
    ...
    def WriteDataToMemory_exec(self, c, type, ch):
        return self.client.if_data.WriteDataToMemory(
    ...
    def ReadDataFromMemory_exec(self, c, type, ch):
        self.buf_mem[0:self.rd_size] = self.client.if_data.ReadDataFromMemory(
